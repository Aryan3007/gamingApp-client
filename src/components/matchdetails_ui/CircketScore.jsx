  ...
  useEffect(() => {
    ...
    const fetchScores = async () => {
      try {
        ...
        const team1Name = teams[0]?.querySelector(".team_name")?.textContent || "Not Started Yet";
        ...
        const team2Name = teams[1]?.querySelector(".team_name")?.textContent || "Not Started Yet";
