...
const OddEvenComponent = ({ data, onBetSelect }) => {
  ...
  if (!Array.isArray(data)) {
    return <div className="text-white">No Odd/Even data available</div>
  }
  ...
  return (
    <div className="space-y-4 bg-[#242a31] rounded-lg overflow-hidden mt-4">
      <div className="flex flex-wrap sm:flex-nowrap justify-between items-center p-3 bg-[#2c3847]">
        <h3 className="text-white font-medium w-full sm:w-auto mb-2 sm:mb-0">Odd/Even Market</h3>
