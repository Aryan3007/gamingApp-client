...
export default function Login() {
  ...
  return (
    ...
    <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-gray-900 rounded-lg shadow-lg lg:max-w-4xl">
      <div className="hidden bg-cover lg:block lg:w-1/2" style={{backgroundImage: "url('https://images.unsplash.com/photo-1542751371-adc38448a05e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80')"}}></div>
      ...
      <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <a href="#" className="text-xs text-center text-gray-400 uppercase hover:underline"> login with email</a>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mt-4">
            <label className="block mb-2 text-sm font-medium text-gray-200" htmlFor="LoggingEmailAddress">Email Address</label>
          ...
          <div className="mt-4">
            <div className="flex justify-between">
              <label className="block mb-2 text-sm font-medium text-gray-200" htmlFor="loggingPassword">Password</label>
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <Link to={"/register"} className="text-xs text-gray-400 uppercase hover:underline">or sign up</Link>
