        ...
        <table className="w-full">
          <thead>
            <tr className=" text-left">
              <th className="px-6 py-3 text-xs font-medium text-gray-200 uppercase tracking-wider">Image Title</th>
              <th className="px-6 py-3 text-xs font-medium text-gray-200 uppercase tracking-wider">Actions</th>
            </tr>
          </thead>
