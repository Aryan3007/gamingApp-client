        ...
        <div className="flex flex-wrap justify-center items-center gap-4">
          ...
          <div className="flex gap-2">
            <select
              ...
              className="px-4 py-2 bg-[rgb(var(--color-background))] rounded-lg text-sm text-[rgb(var(--color-text-primary))] border border-[rgb(var(--color-border))] focus:outline-none focus:border-[rgb(var(--color-primary))]"
            >
            ...
            <thead>
              <tr className="bg-[rgb(var(--color-background))] border-b border-[rgb(var(--color-border))]">
                ...
                <th
                  ...
                  onClick={() => requestSort("type")}
                >
                  <div className="flex items-center gap-2">Category {getSortIcon("type")}</div>
                </th>
                <th
                  className="px-4 py-3 text-left text-sm font-medium text-[rgb(var(--color-text-muted))] cursor-pointer"
            ...
            <tbody className="divide-y divide-[rgb(var(--color-border))]">
              {currentItems.map((bet, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-sm text-[rgb(var(--color-text-primary))] capitalize">{bet.category}</td>
